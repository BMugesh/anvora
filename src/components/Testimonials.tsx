...
export const Testimonials = () => {
    ...
    return (
        <section className="py-24 bg-anvora-black relative overflow-hidden flex items-center justify-center">
            {/* Background Glow */}
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-anvora-indigo/5 rounded-full blur-[100px]" />
            ...
            <div className="container mx-auto px-6 relative z-10 max-w-4xl text-center">
                ...
                <div className="min-h-[300px] relative">
                    {testimonials.map((t, i) => (
                        ...
                        >
                            <h3 className="text-2xl md:text-4xl font-display font-medium text-white leading-relaxed mb-8">
                                "{t.text}"
                            </h3>
                            <div>
